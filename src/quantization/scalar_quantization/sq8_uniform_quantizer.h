...
public:
    ...
    inline void
    ComputeBatchDistImpl(Computer<SQ8UniformQuantizer<metric>>& computer,
                         uint64_t count,
                         const uint8_t* codes,
                         float* dists) const;
...
template <MetricType metric>
void
SQ8UniformQuantizer<metric>::ComputeBatchDistImpl(Computer<SQ8UniformQuantizer<metric>>& computer,
                                                  uint64_t count,
                                                  const uint8_t* codes,
                                                  float* dists) const {
